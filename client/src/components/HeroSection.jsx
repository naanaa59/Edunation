        ...
        <div className='mx-auto flex flex-col justify-center lg:flex-row'>
            <div className='lg:w-1/2 lg:ml-6 flex flex-col justify-center'>
                ...
                <div className='lg:max-w'>
                    <a href="/about" class="rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-indigo-600 text-indigo-600 text-white">
